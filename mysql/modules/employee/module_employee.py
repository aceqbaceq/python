...
#
  ...
  #
  # step 9 |  employee2 (employee_id, claim_confirm_employee_id)
  #
  A_table = "employee"
  #print "module employee | enter step with %s table"  %(A_table)
  ...
  if myresult:
     for x in myresult:
         module_employee2.employee2(  initial_employee2_id=x[0],
                         DB_Host=DB_Host,
                         DB_User=DB_User,
                         DB_Password=DB_Password,
                         DB_Name=DB_Name,
  ...
  #
  # step 9.5 |  employee2 (employee_id, external_invoice_confirm_employee_id)
  #
  A_table = "employee"
  #print "module employee | enter step with %s table"  %(A_table)
  ...
  #
  # step 10 |  employee2 (employee_id, main_curator_employee_id)
  #
  A_table = "employee"
