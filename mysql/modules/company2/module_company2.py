...
def company2 ( initial_company2_id=None, 
            DB_Host=None, 
            DB_User=None, 
            DB_Password=None, 
            DB_Name=None, 
...
#  function 'def company2'  deletes  rows in `company` table using 'initial_company2_id'
#  'initial_company2_id' specifies (company_id)  row in `company` table we want to delete
#

  if (
          initial_company2_id    is None
      or  DB_Host             is None
      or  DB_User             is None
  ...
  mycursor.execute(query, (initial_company2_id, ))
  ...
  for x in myresult:
         ...
         #print "\n"
  if l == 0:
     #print colored("file %s | ERROR: | 'company_id' is not found, please specify another 'initial_company2_id'. \n ", 'red') % (__file__)
     return
  else: 
      d=x[0]
  ...
  #print "module company2 | enter step with %s table"  %(A_table)
